-- ============================================================================
-- V 1 12: Tenant Intelligence
-- ============================================================================
-- Purpose
--   - Compute tenant reliability, risk, exposure, tenure, and payment behavior insights.
--   - Expose property options and tenant intelligence directory payloads for owner workflows.
--   - Keep quality hardening close to the analytics RPCs it replaces.
--
-- Consolidated before first production publication. Tenant intelligence patches
-- are folded into this canonical analytics migration for easier maintenance.
-- ============================================================================
-- ----------------------------------------------------------------------------
-- Tenant intelligence dashboard
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- Tenant intelligence quality hardening
-- ----------------------------------------------------------------------------
