-- ============================================================================
-- V 1.27: Refresh Payment Setup Update RPC
-- ============================================================================
-- Purpose: Recreate the payment setup credential update RPC and explicitly
--          refresh PostgREST's schema cache for production deployments.
-- ============================================================================
...
begin
  ...
  set
    ...
    account_reference_hint = nullif(trim(coalesce(p_account_reference_hint, '')), '')
  where id = p_setup_id;
end;
$$;
