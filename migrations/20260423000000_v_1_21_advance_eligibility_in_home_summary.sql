-- ============================================================================
-- V 1 21: Embed Advance Payment Eligibility in Tenant Home Summary
-- ============================================================================
-- Purpose:
--   Include get_tenant_advance_payment_eligibility result directly inside
--   get_tenant_home_summary so the mobile app can render the correct payment
--   card state (eligible / advance_lock / all_periods_covered / etc.) in a
--   single round-trip. Eligibility is fetched for p_requested_months = 3 so
--   the UI knows the maximum available months for the advance bundle selector.
-- ============================================================================
